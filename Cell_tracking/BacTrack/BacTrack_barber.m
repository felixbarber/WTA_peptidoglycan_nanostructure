...
maxW=3.0;%Maximum cell width, set to 2.0 for tunicamycin shock, 3.0 for 
% ponA O.E,

num_scenes = 4;
basename1='260225_bFB292_IPTG_Mg_long';
data_loc='/Users/barber.527/Documents/Barber_lab/data/';
...
for i0=1:num_scenes % changed from num_scenes
    ...
    lscale=0.065;%%Microns per pixel. 0.0929 for Rojas lab data. 0.065nm/pixel for Barber lab data.
