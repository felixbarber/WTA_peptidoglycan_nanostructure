...
for i0=1:num_scenes
    ...
    dirname=['D:/Documents_D/Rojas_lab/data/' basename1 '/' basename '_1_a'];%Directory that the image stack is saved in.
    %basename='070512_6';skp=[];%Name of the image stack, used to save file.    
    savedir=['D:/Documents_D/Rojas_lab/data/data'];%Directory to save the output .mat file to.
