...
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_activity.png',dpi=300, bbox_inches='tight')
plt.clf()
...
plt.xlabel('Time post ' + pert +' (mins)')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_activity_ball.png',dpi=300, bbox_inches='tight')
plt.clf()
...
plt.xlabel('Time post ' + pert +' (mins)')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_speed.png',dpi=300, bbox_inches='tight')
plt.clf()
...
plt.xlabel('Time post ' + pert +' (mins)')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_speed_ball.png',dpi=300, bbox_inches='tight')
plt.clf()
...
plt.xlabel('Time post ' + pert +' (mins)')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_density.png',dpi=300, bbox_inches='tight')
plt.clf()
...
plt.xlabel('Time post ' + pert +' (mins)')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_density_ball.png',dpi=300, bbox_inches='tight')
plt.clf()
...
plt.xlabel('Time (min)')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_activity_percent.eps', bbox_inches='tight')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_activity_percent.png',dpi=300, bbox_inches='tight')
plt.clf()
...
plt.xlabel('Time (min)')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_ballistic_speed_cumulative.eps', bbox_inches='tight')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_ballistic_speed_cumulative.png',dpi=300, bbox_inches='tight')
plt.clf()
...
plt.ylabel(r'Speed ($\mu$m/s)')
plt.xlabel('Time (min)')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_general_speed_cumulative.eps', bbox_inches='tight')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_general_speed_cumulative.png',dpi=300, bbox_inches='tight')
plt.clf()
...
sns.set_style("whitegrid")
fig=plt.figure(figsize=[2, 1.5])
sns.lineplot(x='Time',y='Density ball.',data=df2,err_style='bars',errorbar='se',err_kws={'capsize':2},markers=None)
# sns.pointplot(x='Time', y='Percent_act', estimator=np.mean, data=df[df.tmp==1], capsize=0.1,join=1, markers='.')
ax = plt.gca()
plt.vlines(0, ymin=ax.get_ylim()[0], ymax=ax.get_ylim()[1], linestyle='-', colors='k', lw=0.5)
plt.ylabel(r'Density ($1/\mu m^2$)')
plt.xlabel('Time (min)')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_ballistic_density_cumulative.eps', bbox_inches='tight')
fig.savefig('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/'+lab+'_ballistic_density_cumulative.png',dpi=300, bbox_inches='tight')
plt.clf()

with open('/Users/felixbarber/Documents/GitHub/Rojas_lab_drafts/outputs/compiled_data/rod_complex_plots/' + lab+'.txt', 'w') as f:
